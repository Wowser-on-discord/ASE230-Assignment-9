            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav ms-auto navbar-center" id="navbar-navlist">
                        ...
                        <li class="nav-item">
                            <a href="#blog" class="nav-link">Awards</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <a href="admin/" class="btn btn-sm rounded-pill nav-btn ms-lg-3" style="background-color:red;">Administrator Pages</a>
                </div>
            </div>
            <!-- end container -->
        </nav>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center">
                            ...
                            <?php
                                ob_start();
                                include "lib/plaintxtfunction.php";
                                ob_end_clean();
                                readPlainTxt();
                                echo "<br><br>"
                            ?>
        ...
        <section class="section bg-light" id="team">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <?php
                        ob_start();
                        require('lib/csvfunction.php');
                        ob_end_clean();
                        //print(readCSV("csvinfo.csv"));
                        displayCSVData("team.csv");
